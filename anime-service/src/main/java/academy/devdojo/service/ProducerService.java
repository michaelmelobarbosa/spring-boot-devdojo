...
import academy.devdojo.repository.ProducerHardDCodedRepository;
...
public class ProducerService {
    private ProducerHardDCodedRepository repository;

    public ProducerService() {
        this.repository = new ProducerHardDCodedRepository();
    }
